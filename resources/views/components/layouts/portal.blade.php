    ...
    <aside class="sidebar" :class="{ open: sidebarOpen }">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('portal.register-address-indexing') }}"
                class="nav-item {{ request()->routeIs('portal.register-address-indexing') ? 'active' : '' }}">
                <i class="fas fa-map-signs"></i> Address Indexing (Google Maps)
            </a>
            <a href="{{ route('portal.street-revalidation') }}"
                class="nav-item {{ request()->routeIs('portal.street-revalidation') ? 'active' : '' }}">
                <i class="fas fa-sync-alt"></i> Revalidate Street
            </a>
            <a href="{{ route('portal.request-numbering-plates') }}"
                class="nav-item {{ request()->routeIs('portal.request-numbering-plates') ? 'active' : '' }}">
                <i class="fas fa-sign"></i> Request Numbering Plates
            </a>
            ...
            <div class="nav-section-title">Tools &amp; Information</div>
        ...
        <div class="sidebar-footer">
            ...
            @endauth
            <div style="margin-top:12px;opacity:0.4;font-size:10px;">© {{ date('Y') }} Njikoka LGA · NDSMS v1.0
            </div>
        </div>
    </aside>
